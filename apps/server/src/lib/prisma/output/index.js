...
const config = {
  "generator": {
    ...
    "output": {
      "value": "/Users/hayashi/Desktop/mywork/nextjs-hono-template/src/api/lib/prisma/output",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
    ...
    "previewFeatures": [],
    "sourceFilePath": "/Users/hayashi/Desktop/mywork/nextjs-hono-template/src/api/lib/prisma/schema.prisma",
    "isCustomOutput": true
  },
  "relativeEnvPaths": {
    "rootEnvPath": null,
  ...
  "inlineSchemaHash": "c75440b73ab1e751e4806dacbff56e4734198b89414edbb8af1f95a349f982a2",
  "copyEngine": true
}
...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
  const alternativePaths = [
    "src/api/lib/prisma/output",
    "api/lib/prisma/output",
  ]
...
path.join(process.cwd(), "src/api/lib/prisma/output/libquery_engine-darwin-arm64.dylib.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "src/api/lib/prisma/output/schema.prisma")
